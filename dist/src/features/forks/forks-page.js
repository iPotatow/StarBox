...
function workflowResultLabel(fork) { const state = workflowState(fork); return state === "success" ? "成功" : state === "failure" ? "失败" : state === "running" ? "运行中" : "无运行记录"; }
export function ForksPage({ state, onStateChange: _onStateChange, goToSettings, initialLoading = false }) {
    ...
    const loadForks = useCallback(async () => {
        ...
        try {
            ...
            setForks(next);
            setSuccess("");
            notify("Fork 已刷新", `${next.length} 个仓库 · 上游与 Actions 状态已更新`, "success");
        }
        catch (reason) {
    ...
    async function syncUpstream(fork) {
        ...
        try {
            ...
            setSuccess("");
            notify("上游已同步", result.message || fork.fullName, "success");
            const detail = await fetchForkDetails(token, fork.fullName);
    ...
    async function runWorkflow() {
        ...
        try {
            ...
            setWorkflowInputError(reason instanceof Error ? reason.message : "输入参数格式无效");
            return;
        }
        setDispatching(true);
        setError("");
    ...
    return _jsxs("div", { className: "mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8", children: [_jsxs("header", { className: "mb-5 flex items-end justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-xl font-semibold tracking-tight", children: "Fork" }), _jsxs("p", { className: "mt-1 text-sm text-muted-foreground", children: [forks.length, " \u4E2A Fork \u00B7 \u67E5\u770B\u4E0E\u4E0A\u6E38\u7684\u5DEE\u5F02\u548C Actions \u72B6\u6001\u3002"] })] }), _jsxs(Button, { onClick: () => void loadForks(), loading: loading, disabled: !hasGithubCredential, children: [_jsx(RiRefreshLine, { className: "size-4" }), "\u5237\u65B0 GitHub"] })] }), _jsx(StatusBanner, { error: error, success: !error ? success : "" }), _jsxs(Toolbar, { className: "mb-5", "aria-label": "Fork \u5DE5\u5177\u680F", children: [_jsx(ToolbarGroup, { className: "min-w-[240px] flex-1", children: _jsxs(InputGroup, { className: "min-w-[220px]", children: [_jsx(InputGroupInput, { type: "search", "data-search-shortcut": "true", "aria-label": "\u641C\u7D22 Fork", value: query, onChange: (event) => { setQuery(event.target.value); setPage(1); }, placeholder: "\u641C\u7D22 Fork / \u4E0A\u6E38 / Workflow" }), _jsx(InputGroupAddon, { children: _jsx(RiSearchLine, { className: "size-4", "aria-hidden": "true" }) })] }) }), _jsx(ToolbarSeparator, {}), _jsxs(ToolbarGroup, { children: [_jsxs(Select, { "aria-label": "\u7B5B\u9009\u4E0A\u6E38\u72B6\u6001", value: upstreamFilter, onChange: (event) => { setUpstreamFilter(event.target.value); setPage(1); }, className: "min-w-32", children: [_jsx("option", { value: "all", children: "\u5168\u90E8\u4E0A\u6E38" }), _jsx("option", { value: "behind", children: "\u843D\u540E" }), _jsx("option", { value: "ahead", children: "\u9886\u5148" }), _jsx("option", { value: "synced", children: "\u5DF2\u540C\u6B65" }), _jsx("option", { value: "unknown", children: "\u672A\u77E5" })] }), _jsxs(Select, { "aria-label": "\u7B5B\u9009 Actions \u72B6\u6001", value: workflowFilter, onChange: (event) => { setWorkflowFilter(event.target.value); setPage(1); }, className: "min-w-32", children: [_jsx("option", { value: "all", children: "\u5168\u90E8 Actions" }), _jsx("option", { value: "success", children: "\u6210\u529F" }), _jsx("option", { value: "failure", children: "\u5931\u8D25" }), _jsx("option", { value: "running", children: "\u8FD0\u884C\u4E2D" }), _jsx("option", { value: "none", children: "\u65E0\u8FD0\u884C\u8BB0\u5F55" })] }), _jsxs(Select, { "aria-label": "Fork \u6392\u5E8F\u65B9\u5F0F", value: sort, onChange: (event) => { setSort(event.target.value); setPage(1); }, className: "min-w-32", children: [_jsx("option", { value: "updated", children: "\u66F4\u65B0\u65F6\u95F4" }), _jsx("option", { value: "behind", children: "\u843D\u540E\u6570\u91CF" }), _jsx("option", { value: "ahead", children: "\u9886\u5148\u6570\u91CF" }), _jsx("option", { value: "name", children: "\u540D\u79F0" })] }), _jsx(Tooltip, { content: direction === "desc" ? "当前逆序，点击切换正序" : "当前正序，点击切换逆序", children: _jsx(Button, { variant: "outline", size: "icon", "aria-label": direction === "desc" ? "切换为正序" : "切换为逆序", onClick: () => { setDirection((value) => value === "desc" ? "asc" : "desc"); setPage(1); }, children: _jsx(RiArrowDownLine, { className: cn("size-4 transition-transform", direction === "asc" && "rotate-180") }) }) })] })] }), _jsx("div", { ref: resultsTopRef }), !hasGithubCredential ? _jsxs("div", { className: "rounded-xl border border-dashed border-border p-8 text-center", children: [_jsx("p", { className: "text-sm text-muted-foreground", children: "\u8FDE\u63A5 GitHub \u51ED\u636E\u540E\u624D\u80FD\u8BFB\u53D6\u5DF2 Fork \u4ED3\u5E93\u3002" }), _jsxs(Button, { className: "mt-3", variant: "outline", onClick: () => goToSettings("account"), children: [_jsx(RiSettings4Line, { className: "size-4" }), "\u6253\u5F00\u8BBE\u7F6E"] })] })
                : pageLoading ? _jsx(ListSkeleton, { rows: 8 })
                    : _jsxs(Card, { render: _jsx("section", {}), className: "overflow-hidden rounded-xl shadow-card", children: [_jsxs("div", { className: "grid grid-cols-[minmax(0,1fr)_110px_140px_140px] gap-3 border-b border-border bg-secondary/35 px-4 py-2 text-xs font-medium text-muted-foreground max-md:grid-cols-[minmax(0,1fr)_90px]", children: [_jsx("span", { children: "Fork / \u4E0A\u6E38" }), _jsx("span", { className: "max-md:hidden", children: "\u4E0E\u4E0A\u6E38" }), _jsx("span", { className: "max-md:hidden", children: "Actions" }), _jsx("span", { className: "text-right", children: "\u64CD\u4F5C" })] }), visible.map((fork) => { const status = upstreamState(fork); const actionStatus = workflowState(fork); return _jsxs("article", { className: "grid grid-cols-[minmax(0,1fr)_110px_140px_140px] items-center gap-3 border-b border-border px-4 py-3 last:border-b-0 max-md:grid-cols-[minmax(0,1fr)_90px]", children: [_jsxs("div", { className: "min-w-0", children: [_jsx(Button, { variant: "link", size: "none", onClick: () => void inspectFork(fork), className: "max-w-full truncate text-left text-sm font-semibold", children: fork.fullName }), _jsx("div", { className: "mt-1 flex flex-wrap items-center gap-2 text-xs text-muted-foreground", children: _jsxs("span", { className: "truncate", children: ["\u4E0A\u6E38\uFF1A", fork.parentFullName || "未知"] }) }), _jsxs("div", { className: "mt-1 hidden flex-wrap gap-x-2 text-xs text-muted-foreground max-md:flex", children: [_jsxs("span", { children: ["\u9886\u5148 ", fork.aheadBy ?? "?"] }), _jsxs("span", { children: ["\u843D\u540E ", fork.behindBy ?? "?"] }), _jsxs("span", { children: ["Actions ", fork.latestWorkflow ? workflowResultLabel(fork) : "—"] })] })] }), _jsx("div", { className: "text-xs max-md:hidden", children: fork.aheadBy == null || fork.behindBy == null ? _jsx(Badge, { variant: "secondary", children: "\u672A\u77E5" }) : fork.aheadBy === 0 && fork.behindBy === 0 ? _jsx(Badge, { variant: "success", children: "\u5DF2\u540C\u6B65" }) : _jsxs("div", { className: "flex gap-1", children: [_jsxs(Badge, { variant: "secondary", children: ["\u2191 ", fork.aheadBy] }), _jsxs(Badge, { variant: fork.behindBy > 0 ? "warning" : "secondary", children: ["\u2193 ", fork.behindBy] })] }) }), _jsx("div", { className: "min-w-0 text-xs max-md:hidden", children: fork.latestWorkflow ? _jsxs("a", { href: fork.latestWorkflow.htmlUrl, target: "_blank", rel: "noreferrer", className: "flex min-w-0 items-center gap-1 hover:underline", children: [_jsx("span", { className: cn("size-2 shrink-0 rounded-full", actionStatus === "success" ? "bg-emerald-500" : actionStatus === "failure" ? "bg-destructive" : "bg-warning") }), _jsxs("span", { className: "truncate", children: [fork.latestWorkflow.name, " \u00B7 ", workflowResultLabel(fork)] })] }) : "—" }), _jsxs("div", { className: "flex justify-end gap-1", children: [status === "behind" ? _jsx(Tooltip, { content: "\u540C\u6B65\u4E0A\u6E38", children: _jsx(Button, { size: "sm", variant: "outline", loading: syncing === fork.fullName, onClick: () => void syncUpstream(fork), children: "\u540C\u6B65" }) }) : null, _jsx(Tooltip, { content: "\u8BE6\u60C5 / Workflow", children: _jsx(Button, { size: "icon-sm", variant: "ghost", loading: detailLoading === fork.fullName, onClick: () => void inspectFork(fork), "aria-label": "\u67E5\u770B Fork \u8BE6\u60C5", children: _jsx(RiInformationLine, { className: "size-4" }) }) }), _jsx(Button, { render: _jsx("a", { href: fork.htmlUrl, target: "_blank", rel: "noreferrer" }), size: "icon-sm", variant: "ghost", "aria-label": "\u6253\u5F00 Fork", children: _jsx(RiExternalLinkLine, { className: "size-4" }) })] })] }, fork.id); }), !visible.length ? _jsx(Empty, { className: "m-4 min-h-56 border-0", children: _jsxs(EmptyContent, { children: [_jsx(EmptyIcon, { children: _jsx(RiGitForkLine, { className: "size-5" }) }), _jsx(EmptyTitle, { children: "\u6682\u65E0\u7B26\u5408\u6761\u4EF6\u7684 Fork" }), _jsx(EmptyDescription, { children: "\u8C03\u6574\u641C\u7D22\u3001\u4E0A\u6E38\u6216 Actions \u7B5B\u9009\u6761\u4EF6\u540E\u518D\u8BD5\u3002" })] }) }) : null] }), filtered.length > pageSize ? _jsx(Pagination, { className: "mt-5", children: _jsxs(PaginationContent, { children: [_jsx(PaginationItem, { children: _jsx(PaginationPrevious, { render: _jsx(Button, { size: "sm", variant: "outline", disabled: page <= 1, onClick: () => changePage(page - 1) }) }) }), _jsx(PaginationItem, { children: _jsxs("span", { className: "px-2 text-xs text-muted-foreground", children: [page, "/", totalPages] }) }), _jsx(PaginationItem, { children: _jsx(PaginationNext, { render: _jsx(Button, { size: "sm", variant: "outline", disabled: page >= totalPages, onClick: () => changePage(page + 1) }) }) })] }) }) : null, _jsx(Modal, { open: Boolean(selected), title: selected?.fullName || "Fork", description: selected?.parentFullName ? `上游 ${selected.parentFullName}` : "Fork 详情", onClose: () => setSelected(null), children: selected ? _jsxs("div", { className: "grid gap-4", children: [_jsxs("div", { className: "grid gap-2 rounded-xl border border-border p-3 text-sm sm:grid-cols-2", children: [_jsxs("div", { children: [_jsx("div", { className: "text-xs text-muted-foreground", children: "\u9886\u5148" }), _jsx("div", { className: "mt-1 font-medium", children: selected.aheadBy ?? "未知" })] }), _jsxs("div", { children: [_jsx("div", { className: "text-xs text-muted-foreground", children: "\u843D\u540E" }), _jsx("div", { className: "mt-1 font-medium", children: selected.behindBy ?? "未知" })] })] }), selected.latestWorkflow ? _jsxs("div", { className: "rounded-xl bg-secondary/50 p-3 text-sm", children: [_jsxs("div", { className: "flex items-center gap-2", children: [workflowState(selected) === "success" ? _jsx(RiCheckboxCircleLine, { className: "size-4 text-success-foreground" }) : workflowState(selected) === "failure" ? _jsx(RiErrorWarningLine, { className: "size-4 text-destructive-foreground" }) : _jsx(RiLoader4Line, { className: "size-4 animate-spin text-warning-foreground" }), "\u6700\u8FD1\u4E00\u6B21 Action \u00B7 ", selected.latestWorkflow.name] }), _jsxs("div", { className: "mt-1 text-xs text-muted-foreground", children: [workflowResultLabel(selected), " \u00B7 ", new Date(selected.latestWorkflow.createdAt).toLocaleString("zh-CN")] })] }) : null, _jsxs("div", { className: "rounded-xl border border-border p-4", children: [_jsxs("div", { className: "mb-3", children: [_jsx("h3", { className: "text-sm font-semibold", children: "\u8FD0\u884C GitHub Workflow" }), _jsx("p", { className: "mt-1 text-xs text-muted-foreground", children: "\u5728\u5F53\u524D Fork \u4E0A\u624B\u52A8\u8FD0\u884C Workflow\u3002\u9700\u8981 GitHub Token \u5177\u5907 Actions \u6743\u9650\uFF0C\u4E14\u76EE\u6807 Workflow \u652F\u6301\u624B\u52A8\u8FD0\u884C\u3002" })] }), selected.workflows.length ? _jsxs("div", { className: "grid gap-3", children: [_jsx(Field, { label: "Workflow", children: _jsx(Select, { value: workflowId, onChange: (event) => setWorkflowId(event.target.value), children: selected.workflows.map((workflow) => _jsxs("option", { value: workflow.id, children: [workflow.name, " \u00B7 ", workflow.state] }, workflow.id)) }) }), _jsx(Field, { label: "\u5206\u652F / Ref", children: _jsx(Input, { value: workflowRef, onChange: (event) => setWorkflowRef(event.target.value), placeholder: selected.defaultBranch }) }), _jsxs("details", { className: "rounded-xl border border-border px-3 py-2", children: [_jsx("summary", { className: "cursor-pointer text-sm font-medium", children: "\u9AD8\u7EA7\u8BBE\u7F6E \u00B7 \u8F93\u5165\u53C2\u6570" }), _jsx("div", { className: "mt-3", children: _jsxs(Field, { label: "\u8F93\u5165\u53C2\u6570", error: workflowInputError, children: [_jsx(Textarea, { rows: 3, className: "font-mono text-xs", value: workflowInputs, onChange: (event) => { setWorkflowInputs(event.target.value); setWorkflowInputError(""); }, "aria-invalid": Boolean(workflowInputError) }), _jsxs("span", { className: "text-xs text-muted-foreground", children: ["\u4EC5\u5728 Workflow \u9700\u8981\u989D\u5916\u53C2\u6570\u65F6\u586B\u5199 JSON\uFF1B\u65E0\u53C2\u6570\u65F6\u4FDD\u6301 ", `{}`, " ", `}`, "\uFF0C\u9700\u8981\u53C2\u6570\u65F6\u586B\u5199 JSON\u3002"] })] }) })] }), _jsx(Button, { loading: dispatching, disabled: !workflowId || !workflowRef.trim(), onClick: () => void runWorkflow(), children: "\u8FD0\u884C Workflow" })] }) : _jsx("p", { className: "text-sm text-muted-foreground", children: "\u6B64 Fork \u6CA1\u6709\u53EF\u89C1\u7684 GitHub Actions Workflow\uFF0C\u6216\u5F53\u524D Token \u65E0\u6743\u8BFB\u53D6 Workflow\u3002" })] }), _jsxs("div", { className: "flex flex-wrap gap-2", children: [selected.behindBy && selected.behindBy > 0 ? _jsx(Button, { onClick: () => void syncUpstream(selected), loading: syncing === selected.fullName, children: "\u540C\u6B65\u4E0A\u6E38" }) : null, _jsxs(Button, { render: _jsx("a", { href: selected.htmlUrl, target: "_blank", rel: "noreferrer" }), variant: "outline", children: [_jsx(RiExternalLinkLine, { className: "size-4" }), "\u6253\u5F00 Fork"] }), selected.parentHtmlUrl ? _jsx(Button, { render: _jsx("a", { href: selected.parentHtmlUrl, target: "_blank", rel: "noreferrer" }), variant: "outline", children: "\u6253\u5F00\u4E0A\u6E38" }) : null] })] }) : null })] });
}
