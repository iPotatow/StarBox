...
export function ReleasesPage({ state, onStateChange, goToSettings, goToStars, initialLoading = false }) {
    ...
    async function runSummary(release) { if (!aiEnabled)
        ...
        setSummaryErrors((current) => ({ ...current, [key]: reason instanceof Error ? reason.message : "AI 总结失败" }));
    }
    finally {
        setSummaryLoading("");
    } }
    ...
    return _jsxs("div", { className: "mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8", children: [_jsxs("header", { className: "mb-5 flex items-end justify-between gap-4", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-xl font-semibold tracking-tight", children: "Release" }), _jsxs("p", { className: "mt-1 text-sm text-muted-foreground", children: ["\u6B63\u5728\u5173\u6CE8 ", state.releaseSubscriptions.length, " \u4E2A\u4ED3\u5E93\u7684 Release", state.lastReleaseSyncAt ? ` · 上次同步 ${new Date(state.lastReleaseSyncAt).toLocaleString("zh-CN")}` : ""] })] }), _jsxs(Button, { onClick: () => void sync(), loading: loading, disabled: !state.releaseSubscriptions.length, children: [_jsx(RiRefreshLine, { className: "size-4" }), "\u68C0\u67E5\u66F4\u65B0"] })] }), _jsx(StatusBanner, { error: error, success: !error ? success : "" }), _jsxs(Toolbar, { className: "mb-5", "aria-label": "Release \u5DE5\u5177\u680F", children: [_jsx(ToolbarGroup, { className: "min-w-[260px] flex-1", children: _jsxs(InputGroup, { className: "min-w-[240px]", children: [_jsx(InputGroupInput, { type: "search", "data-search-shortcut": "true", "aria-label": "\u641C\u7D22 Release", value: query, onChange: (event) => { setQuery(event.target.value); setPage(1); }, placeholder: "\u641C\u7D22\u7248\u672C\u3001\u6807\u9898\u548C\u7248\u672C\u8BF4\u660E" }), _jsx(InputGroupAddon, { children: _jsx(RiSearchLine, { className: "size-4", "aria-hidden": "true" }) })] }) }), _jsx(ToolbarSeparator, {}), _jsx(ToolbarGroup, { children: _jsxs(Select, { "aria-label": "\u7B5B\u9009\u8BA2\u9605\u4ED3\u5E93", value: repositoryFilter, onChange: (event) => { setRepositoryFilter(event.target.value); setPage(1); }, className: "min-w-44", children: [_jsx("option", { value: "", children: "\u5168\u90E8\u8BA2\u9605\u4ED3\u5E93" }), state.releaseSubscriptions.map((name) => _jsx("option", { value: name, children: name }, name))] }) }), _jsx(ToolbarSeparator, {}), _jsx(ToolbarGroup, { children: _jsxs(ToggleGroup, { value: [viewMode], onValueChange: (values) => { const next = values.at(-1); if (next === "timeline" || next === "repository") {
                                setViewMode(next);
                                setPage(1);
                            } }, children: [_jsx(ToggleGroupItem, { value: "timeline", className: "w-auto px-2.5 text-xs", children: "\u65F6\u95F4\u7EBF" }), _jsx(ToggleGroupItem, { value: "repository", className: "w-auto px-2.5 text-xs", children: "\u6309\u4ED3\u5E93" })] }) }), _jsx(ToolbarSeparator, {}), _jsx(ToolbarGroup, { children: _jsxs(Select, { "aria-label": "\u7248\u672C\u8303\u56F4", value: releaseScope(settings.latestOnly, settings.includePrereleases), onChange: (event) => updateSettings(scopeSettings(event.target.value)), className: "min-w-40", children: [_jsx("option", { value: "all", children: "\u5168\u90E8\u7248\u672C" }), _jsx("option", { value: "stable", children: "\u4EC5\u7A33\u5B9A\u7248" }), _jsx("option", { value: "latest", children: "\u6BCF\u4ED3\u5E93\u6700\u65B0" }), _jsx("option", { value: "latest-stable", children: "\u6BCF\u4ED3\u5E93\u6700\u65B0\u7A33\u5B9A\u7248" })] }) }), _jsx(ToolbarSeparator, {}), _jsx(ToolbarGroup, { children: _jsxs(Menu, { children: [_jsx(MenuTrigger, { render: _jsx(Button, { variant: "outline", size: "default" }), children: _jsxs("span", { children: ["Assets", assetPlatform !== "all" || assetType !== "all" ? ` · ${assetPlatform === "all" ? "全部平台" : assetPlatform === "macos" ? "macOS" : assetPlatform === "windows" ? "Windows" : assetPlatform === "linux" ? "Linux" : "ARM"}${assetType !== "all" ? ` · ${assetType === "installer" ? "EXE/MSI" : assetType === "package" ? "DEB/RPM" : assetType.toUpperCase()}` : ""}` : ""] }) }), _jsxs(MenuPopup, { className: "min-w-56", children: [_jsx(MenuGroupLabel, { children: "\u5E73\u53F0" }), [['all', '全部平台'], ['macos', 'macOS'], ['windows', 'Windows'], ['linux', 'Linux'], ['arm', 'ARM']].map(([value, label]) => _jsxs(MenuItem, { onClick: () => { setAssetPlatform(value); setPage(1); }, children: [assetPlatform === value ? _jsx(RiCheckLine, { className: "size-4" }) : _jsx("span", { className: "size-4" }), label] }, value)), _jsx(MenuSeparator, {}), _jsx(MenuGroupLabel, { children: "\u6587\u4EF6\u7C7B\u578B" }), [['all', '全部类型'], ['dmg', 'DMG'], ['zip', 'ZIP'], ['appimage', 'AppImage'], ['installer', 'EXE / MSI'], ['package', 'DEB / RPM'], ['apk', 'APK'], ['archive', 'TAR / 7Z']].map(([value, label]) => _jsxs(MenuItem, { onClick: () => { setAssetType(value); setPage(1); }, children: [assetType === value ? _jsx(RiCheckLine, { className: "size-4" }) : _jsx("span", { className: "size-4" }), label] }, value)), assetPlatform !== "all" || assetType !== "all" ? _jsxs(_Fragment, { children: [_jsx(MenuSeparator, {}), _jsx(MenuItem, { onClick: () => { setAssetPlatform("all"); setAssetType("all"); setPage(1); }, children: "\u6E05\u9664\u6587\u4EF6\u7B5B\u9009" })] }) : null] })] }) })] }), !hasGithubCredential ? _jsxs("div", { className: "rounded-xl border border-dashed border-border p-8 text-center", children: [_jsx("p", { className: "text-sm text-muted-foreground", children: "\u9700\u8981 GitHub \u51ED\u636E\u624D\u80FD\u540C\u6B65 Release\u3002" }), _jsxs(Button, { className: "mt-3", variant: "outline", onClick: () => goToSettings("account"), children: [_jsx(RiSettings4Line, { className: "size-4" }), "\u6253\u5F00\u8BBE\u7F6E"] })] })
                : !state.releaseSubscriptions.length ? _jsx(Empty, { className: "min-h-72", children: _jsxs(EmptyContent, { children: [_jsx(EmptyIcon, { children: _jsx(RiStarLine, { className: "size-5" }) }), _jsx(EmptyTitle, { children: "\u8FD8\u6CA1\u6709\u5173\u6CE8 Release" }), _jsx(EmptyDescription, { children: "\u5728 Star \u4E2D\u8BA2\u9605\u4ED3\u5E93\u540E\uFF0C\u65B0\u7248\u672C\u4F1A\u663E\u793A\u5728\u8FD9\u91CC\u3002" }), _jsx(Button, { className: "mt-4", variant: "outline", onClick: goToStars, children: "\u524D\u5F80 Star" })] }) })
