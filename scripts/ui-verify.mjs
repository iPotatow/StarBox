...
const canRasterize = spawnSync("weasyprint", ["--version"], { stdio: "ignore" }).status === 0
...
await writeFile(join(outputDir, "RESULT.txt"), [
  ...
  canRasterize ? "Visual rasterizer: WeasyPrint + pdftoppm" : "Visual rasterizer: unavailable; structural route render checks completed",
