...
const tests = spawnSync(process.execPath, ["--test", "tests/worker.test.mjs", "tests/storage.test.mjs", "tests/contracts.test.mjs", "tests/deploy.test.mjs", "tests/regressions.test.mjs", "tests/quality-regressions.test.mjs"], { stdio: "inherit" });
