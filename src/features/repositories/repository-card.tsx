...
function TopicRow({ topics, activeTopics, selectionMode, onFilterTopic, label }: {
  ...
  return <div className="relative mt-3 h-5 min-w-0">
    ...
    <div ref={measurementRef} aria-hidden="true" className="pointer-events-none invisible absolute left-0 top-0 flex h-5 items-center gap-1.5 whitespace-nowrap">
