...
export function RepositoryDetail({ open, repository, token, credentialConnected, onClose, onPrevious, onNext, previousDisabled = false, nextDisabled = false }: {
  ...
  return <Modal open={open} title={repository.full_name} description={repository.description || t("仓库详情", "Repository details")} onClose={onClose} className="sm:h-[88vh] sm:max-w-7xl">
