...
type StyledDescriptionProps = Omit<PopoverPrimitive.Description.Props, "className"> & { className?: string };

export const PopoverCreateHandle: typeof PopoverPrimitive.createHandle = PopoverPrimitive.createHandle;
export const Popover: typeof PopoverPrimitive.Root = PopoverPrimitive.Root;

export function PopoverTrigger({ className, children, ...props }: PopoverPrimitive.Trigger.Props): ReactElement {
  return <PopoverPrimitive.Trigger className={className} data-slot="popover-trigger" {...props}>{children}</PopoverPrimitive.Trigger>;
}
...
export function PopoverClose(props: PopoverPrimitive.Close.Props): ReactElement {
  return <PopoverPrimitive.Close data-slot="popover-close" {...props} />;
}

export function PopoverTitle({ className, ...props }: StyledTitleProps): ReactElement {
  return <PopoverPrimitive.Title className={cn("font-semibold text-lg leading-none", className)} data-slot="popover-title" {...props} />;
}

export function PopoverDescription({ className, ...props }: StyledDescriptionProps): ReactElement {
